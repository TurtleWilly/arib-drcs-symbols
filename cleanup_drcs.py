...
#
#  History:
#       1.5 (18-Jul-2024) - Updated look up table
...
mappings = {
	...
	'0EB2FFE3A6BB50A846711DA465E40278': '[ｽﾏﾎｱﾗｰﾄ]',
	...
	'36C49DFC3BDD10E40ED69A6D3C342875': '逢',
	...
	'44CBC7DC0AF84F6AB857F00A9BC2560A': '⎚',
	'4747AF09D9BA2F184CA5D1985910EFE7': '[ｲｱﾎﾝ]',
	'4901D207BFC017051FDCF6629492BF24': '⤴︎',
	'4975836AA32BC7BE4376CA1B2FFE226A': 'ì',
	'4AD56504A7066270BE7CAD51C0B05E17': '彅', 	
	...
	'90FA5A71875E1E0D52A623465A7043AB': '﨑',
	'9140C12A79C679589C6E4546924D7E07': 'è',
	...
	'A1ACA3019ACEBE43380AC4F1033B2A8D': '﨑',
	...
	'B1ABBE58BAC2342AE82DF6C19FB2D192': '遡',
	'B3E0BE16A1818CD8D4CC5E1D20B27CBC': '[TV]',
	'B84B5D9232B091B461BAA1C07950E76B': '﨑',
	'C01D2BAFCE469DA1ABBB612FDB16C1E3': '元',
	'C06A278CFFC82DDC67709E5E9577F148': '↱',
	...
	'CCB96A769F9CD55EBDF67B5C03495C0E': '﨑',
	...
	try:
		with open(filename_in, 'rt', encoding='utf8', newline=None) as fi, open(filename_out, 'xt', encoding='utf8', newline='\n') as fo:
			while True:
				...
				if '[ARIBEXT:' in line or '・' in line:
					print("Warning: potential ARIB STD B24 extended character in line: <", line, ">", sep='', file=sys.stderr)
